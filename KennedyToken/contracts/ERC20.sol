...
require(from != address(0), "ERC20 from zero address not acceptable");
require(to != address(0), "ERC20 to zero address not acceptable");
...
function mint(address to , uint256 amount) public {
    require(to != address(0), "mint to the zero adress is not acceptable!");
    _totalSupply += amount;
...
function burn(address account , uint256 amount) public {
        require(account != address(0), "burn from the zero adress is not acceptable!");
